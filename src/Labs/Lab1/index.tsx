  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe, World's Best Grilled Cheese:
        <ol id="wd-your-favorite-recipe">
          <li>Extravagantly butter the outside of two slices of bread, plus the inside of one of them</li>
          <li>Arrange sliced cheese of your choice on bread (Vermont sharp cheddar is my go-to)</li>
          <li>Heat a pan (with more butter)</li>
          <li>Grill the sandwitch until bread is golden brown and cheese is melted</li>
          <li>Enjoy!</li>
        </ol>
        ...
        <ul id="wd-your-books">
          <li>The Way of Kings (basically the whole Stormligh Archive series, I can't choose)</li>
      ...
      <div id="wd-anchors">
        ...
        Source code for this site: <a href="https://github.com/celiaburrington/kambas-react-web-app" id="wd-github">click here</a>
      </div> 
    </div>
  );
}